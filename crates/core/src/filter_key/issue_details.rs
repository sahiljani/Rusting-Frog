...
impl FilterKey {
    ...
    pub fn description(&self) -> Option<&'static str> {
        ...
        Some(match self {
            ...
            H2Duplicate => "Pages sharing an identical H2 with another page.",
            H2Multiple => {
            ...
            DirectivesOutsideHead => "Robots meta tag placed outside <head> — ignored by Google.",
            ...
            ContentLowContentPages => "Pages whose word count is below the low-content threshold.",
            ContentDuplicates => "Pages with identical HTML content body.",
            ContentSoft404Pages => {
            ...
            ValidationMissingBody => "Pages missing a <body> element.",
            ...
            ValidationMultipleHeads => "Pages with more than one <head> element.",
            ValidationMultipleBodies => "Pages with more than one <body> element.",
            ...
            MobileTargetSize => "Tap targets smaller than 48x48 CSS pixels or too close together.",
    ...
    pub fn how_to_fix(&self) -> Option<&'static str> {
        ...
        Some(match self {
            ...
            TitleMultiple => "Remove the extra <title> elements so exactly one remains in <head>.",
            ...
            H1Multiple => "Demote additional H1s to H2/H3 — keep exactly one H1.",
            H1Duplicate => "Rewrite so each page has a unique H1.",
            ...
            SecurityFormUrlInsecure => "Change the form's action to an HTTPS URL.",
            SecurityMissingHstsHeader => {
